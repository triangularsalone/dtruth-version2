...
export default function InnovationForSalvation() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Innovation for Salvation</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Pioneering solutions and transformative initiatives that create lasting positive change and community impact.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-600">No innovation content published yet. Check back soon!</p>
          </div>
        ) : (
