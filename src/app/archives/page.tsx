      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Comprehensive collection of LEAP's documents, photos, videos, and reports since 2010.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-600">No archived content published yet. Check back soon!</p>
          </div>
        ) : (
