    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">LEAP Vision</h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">A dedicated page for the idea, the journey, and the places LEAP has reached.</p>
        </div>
        ...
        <section className="grid gap-12 lg:grid-cols-2">
          <div className="space-y-6">
            ...
            <p className="text-gray-600 leading-relaxed">LEAP is more than a project; it is a movement to document, empower, and connect communities through transformative work.</p>
            <ul className="space-y-4">
              <li className="flex gap-4">
                <span className="mt-1 h-2 w-2 rounded-full bg-indigo-600"></span>
                <span>Showcase the journey of LEAP through verified media and reports.</span>
              </li>
              <li className="flex gap-4">
                <span className="mt-1 h-2 w-2 rounded-full bg-indigo-600"></span>
          ...
          <div className="space-y-8">
            <div className="rounded-3xl border border-gray-200 bg-indigo-50 p-8">
              ...
              <p className="text-gray-600 leading-relaxed">LEAP has steadily advanced through innovation, collaboration, and strategic community work. Each milestone is part of the broader movement toward positive social impact.</p>
            </div>
        ...
        <section className="mt-20 rounded-3xl bg-slate-900 p-10 text-white">
          ...
          <p className="text-slate-200 leading-relaxed">This page is designed so you can add the main idea video and keep the movement story separate from the home page. It becomes the destination for anyone who wants to learn the full vision behind LEAP.</p>
        </section>
      </main>
    </div>
  )
